...
#include <QWeb QWebEngineWidgets> //added for Qt5
...
int main(int argc, char *argv[])
{
    ...
    webSettings->setAttribute(QWebEngineSettings::ZoomTextOnly, true);
#endif
#ifdef DEBUG
    webSettings->setAttribute(QWebEngineSettings::DeveloperExtrasEnabled,
                              true);
#endif
