#ifndef HC_HDTY_D_FILTER_WGT_H
#define HC_HDTY_D_FILTER_WGT_H
...
class hC_hDty_D_filter_wgt : public QLineEdit
{
    Q_OBJECT
...
public:
    explicit hC_hDty_D_filter_wgt(QWidget *parent = nullptr);
